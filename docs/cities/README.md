...
This directory records researched source candidates for city adapters. Edmonton is the live baseline. Vancouver, Calgary, Toronto, and Hamilton have research-backed manifests, but their generated datasets are not shipped in the public deployment until a city-specific pipeline adapter is implemented and verified.
